...
static bool	gutenprint_gen_rendpage(pappl_job_t *job, pappl_pr_options_t *options, pappl_device_t *device, unsigned page);
static bool	gutenprint_gen_rstartjob(pappl_job_t *job, pappl_pr_options_t *options, pappl_device_t *device);
static bool	gutenprint_gen_rstartpage(pappl_job_t *job, pappl_pr_options_t *options, pappl_device_t *device, unsigned page);
static bool	gutenprint_gen_status(pappl_printer_t *printer);
...
{
  data->printfile_cb  = gutenprint_gen_printfile;
  data->rendjob_cb    = gutenprint_gen_rendjob;
  data->rendpage_cb   = gutenprint_gen_rendpage;
  data->rstartjob_cb  = gutenprint_gen_rstartjob;
  data->rstartpage_cb = gutenprint_gen_rstartpage;
  data->rwriteline_cb = gutenprint_gen_rwriteline;
  data->status_cb     = gutenprint_gen_status;
  data->format        = "application/vnd.cups-paged-gutenprint";
...
//
// 'gutenprint_gen_rwriteline()' - Write a raster line.
//
static bool				// O - `true` on success, `false` on failure
gutenprint_gen_rwriteline(
    pappl_job_t         *job,		// I - Job
    pappl_pr_options_t  *options,	// I - Job options
    pappl_device_t      *device,	// I - Output device
